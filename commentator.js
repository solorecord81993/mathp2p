...
export const COMMENTATOR_PHRASES = {
  ...
  // Explains the game itself, said periodically so viewers who just tuned in understand
  // what they're watching and how to join.
  howToPlay: [
    'เกมนี้คือ Math Battle ครับ ผู้เล่นเอาตัวเลขที่ได้มาบวก ลบ คูณ หาร ให้ได้ผลลัพธ์ตรงกับเป้าหมายให้เร็วที่สุด',
    'กติกาง่าย ๆ ครับ ตอบถูกเร็วที่สุดได้ 3 คะแนน คนที่ 2 ได้ 2 คะแนน คนอื่นที่ตอบถูกได้ 1 คะแนนครับ',
    'อยากเล่นด้วยก็เปิดเว็บตาม QR code ที่ขึ้นด้านบน แล้วใส่รหัสห้องได้เลยครับ ง่ายมาก',
    'Math Battle เล่นสนุกได้ทั้งเด็กและผู้ใหญ่ ฝึกคิดเลขเร็วไปในตัวด้วยนะครับ',
    'ต้องใช้ตัวเลขที่ได้มาทุกตัวนะครับ ห้ามเหลือห้ามขาด บวกลบคูณหารสลับกันยังไงก็ได้ให้ตรงเป้าหมาย',
    'ใครตอบถูกก่อนเพื่อนคือได้เปรียบสุดครับ เพราะยิ่งเร็วยิ่งได้คะแนนเยอะ',
  ],
  filler_playing: [
